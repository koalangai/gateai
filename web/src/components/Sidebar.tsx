    ...
    return (
        ...
        >
            ...
            <Box sx={{display: 'flex', gap: 1, alignItems: 'center'}}>
                ...
                <Typography level="title-lg">GateAI</Typography>
                        ...
                        <Toggler
                            renderToggle={({open, setOpen}) => (
                                <ListItemButton onClick={() => setOpen(!open)}>
                                    ...
                                    <ListItemContent>
                                        <Typography level="title-sm">Usage</Typography>
                                    </ListItemContent>
                            ...
                            <List sx={{gap: 0.5}}>
                                <ListItem sx={{mt: 0.5}}>
                                    <ListItemButton component="a"
                                                    href={import.meta.env.BASE_URL + "usage/application"}>Application</ListItemButton>
                                </ListItem>
                                <ListItem>
                                ...
                                <ListItem>
                                    <ListItemButton>Batch</ListItemButton>
                                </ListItem>
                            </List>
                        </Toggler>
                    </ListItem>
                    ...
                    <ListItem nested>
                        ...
                        >
                            <List sx={{gap: 0.5}}>
                                ...
                                <ListItem>
                                    <ListItemButton>Providers</ListItemButton>
                                </ListItem>
                                <ListItem>
